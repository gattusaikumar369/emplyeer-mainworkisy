...
const ResdoxReport=()=>{
  ...
  const currentRows = resdoxList.slice(indexOfFirstRow, indexOfLastRow);
  if(resdoxList.length>1){
     rowsPerPage=3
  }else{
     rowsPerPage=1
  }
    return(
        <div>
           ...
           <div className='resdox-cnt'>
              ...
              <Pagination
                    count={Math.ceil(resdoxList.length / rowsPerPage)} // Total number of pages
                    page={currentPage}
